...
// I ussed a sample code from the processing website and also a code used as an example from our week 6 lab.
// the code I used from the processing website allows the circles to bounce off of the sides of the window
